...
public record ContactData
        (String id, String firstName, String middleName, String lastName, String nickname, String title, String company,
         ...
         String birthMonth, String birthYear, String group, String photo) {
    public ContactData() {
        this("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
    }
    ...
    public ContactData withId(String id) {
        return new ContactData(id, firstName, this.middleName, this.lastName,
                ...
                this.birthDay, this.birthMonth, this.birthYear, this.group, this.photo);
    }
    ...
    public ContactData withBirthDay(String birthDay) {
        return new ContactData(this.id, this.firstName, this.middleName, this.lastName,
                this.nickname, this.title, this.company, this.address,
                this.homePhone, this.fax, this.email, this.homepage,
                birthDay, this.birthMonth, this.birthYear, this.group, this.photo);
    }
    ...
    public ContactData withBirthMonth(String birthMonth) {
        return new ContactData(this.id, this.firstName, this.middleName, this.lastName,
                this.nickname, this.title, this.company, this.address,
                this.homePhone, this.fax, this.email, this.homepage,
                this.birthDay, birthMonth, this.birthYear, this.group, this.photo);
    }
    ...
    public ContactData withBirthYear(String birthYear) {
        return new ContactData(this.id, this.firstName, this.middleName, this.lastName,
                this.nickname, this.title, this.company, this.address,
                this.homePhone, this.fax, this.email, this.homepage,
                this.birthDay, this.birthMonth, birthYear, this.group, this.photo);
    }
    ...
    public ContactData withGroup(String group) {
        return new ContactData(this.id, this.firstName, this.middleName, this.lastName,
                this.nickname, this.title, this.company, this.address,
                this.homePhone, this.fax, this.email, this.homepage,
                this.birthDay, this.birthMonth, this.birthYear, group, this.photo);
    }
    ...
    public ContactData withPhoto(String photo) {
        return new ContactData(this.id, this.firstName, this.middleName, this.lastName,
                this.nickname, this.title, this.company, this.address,
                this.homePhone, this.fax, this.email, this.homepage,
                this.birthDay, this.birthMonth, this.birthYear, this.group, photo);
    }
}